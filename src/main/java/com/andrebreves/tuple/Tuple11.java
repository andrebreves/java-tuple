 ...
 * @author Andre Breves
 */
public final class Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> implements Tuple, Comparable<Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>> {
    ...
    public <R> Tuple11<R, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> mapV1(Function<T1, R> mapper) {
        return Tuple11.of(mapper.apply(v1), v2, v3, v4, v5, v6, v7, v8, v9, v10, v11);
    }

    /** Returns a Tuple mapping the 2nd value using the giving mapper function, and keeping the remaining values unchanged. */
    public <R> Tuple11<T1, R, T3, T4, T5, T6, T7, T8, T9, T10, T11> mapV2(Function<T2, R> mapper) {
        return Tuple11.of(v1, mapper.apply(v2), v3, v4, v5, v6, v7, v8, v9, v10, v11);
    }

    /** Returns a Tuple mapping the 3rd value using the giving mapper function, and keeping the remaining values unchanged. */
    public <R> Tuple11<T1, T2, R, T4, T5, T6, T7, T8, T9, T10, T11> mapV3(Function<T3, R> mapper) {
        return Tuple11.of(v1, v2, mapper.apply(v3), v4, v5, v6, v7, v8, v9, v10, v11);
    }

    /** Returns a Tuple mapping the 4th value using the giving mapper function, and keeping the remaining values unchanged. */
    public <R> Tuple11<T1, T2, T3, R, T5, T6, T7, T8, T9, T10, T11> mapV4(Function<T4, R> mapper) {
        return Tuple11.of(v1, v2, v3, mapper.apply(v4), v5, v6, v7, v8, v9, v10, v11);
    }

    /** Returns a Tuple mapping the 5th value using the giving mapper function, and keeping the remaining values unchanged. */
    public <R> Tuple11<T1, T2, T3, T4, R, T6, T7, T8, T9, T10, T11> mapV5(Function<T5, R> mapper) {
        return Tuple11.of(v1, v2, v3, v4, mapper.apply(v5), v6, v7, v8, v9, v10, v11);
    }

    /** Returns a Tuple mapping the 6th value using the giving mapper function, and keeping the remaining values unchanged. */
    public <R> Tuple11<T1, T2, T3, T4, T5, R, T7, T8, T9, T10, T11> mapV6(Function<T6, R> mapper) {
        return Tuple11.of(v1, v2, v3, v4, v5, mapper.apply(v6), v7, v8, v9, v10, v11);
    }

    /** Returns a Tuple mapping the 7th value using the giving mapper function, and keeping the remaining values unchanged. */
    public <R> Tuple11<T1, T2, T3, T4, T5, T6, R, T8, T9, T10, T11> mapV7(Function<T7, R> mapper) {
        return Tuple11.of(v1, v2, v3, v4, v5, v6, mapper.apply(v7), v8, v9, v10, v11);
    }

    /** Returns a Tuple mapping the 8th value using the giving mapper function, and keeping the remaining values unchanged. */
    public <R> Tuple11<T1, T2, T3, T4, T5, T6, T7, R, T9, T10, T11> mapV8(Function<T8, R> mapper) {
        return Tuple11.of(v1, v2, v3, v4, v5, v6, v7, mapper.apply(v8), v9, v10, v11);
    }

    /** Returns a Tuple mapping the 9th value using the giving mapper function, and keeping the remaining values unchanged. */
    public <R> Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, R, T10, T11> mapV9(Function<T9, R> mapper) {
        return Tuple11.of(v1, v2, v3, v4, v5, v6, v7, v8, mapper.apply(v9), v10, v11);
    }

    /** Returns a Tuple mapping the 10th value using the giving mapper function, and keeping the remaining values unchanged. */
    public <R> Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, R, T11> mapV10(Function<T10, R> mapper) {
        return Tuple11.of(v1, v2, v3, v4, v5, v6, v7, v8, v9, mapper.apply(v10), v11);
    }

    /** Returns a Tuple mapping the 11th value using the giving mapper function, and keeping the remaining values unchanged. */
    public <R> Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> mapV11(Function<T11, R> mapper) {
        return Tuple11.of(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, mapper.apply(v11));
    }

    @FunctionalInterface
    public interface ValuesConsumer<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {
    ...
    public void consumeValues(ValuesConsumer<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> consumer) {
        consumer.accept(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11);
    }

    @FunctionalInterface
    public interface ValuesFunction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, R> {
    ...
    public <R> R mapValues(ValuesFunction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, R> function) {
        return function.apply(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11);
    }

    @FunctionalInterface
    public interface ValuesPredicate<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> {
    ...
    public boolean testValues(ValuesPredicate<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> predicate) {
        return predicate.test(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11);
    }

    /** Returns a Tuple containing the values of this Tuple and the values passed as parameters. */
    public <T12> Tuple12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> append(T12 v12) {
    ...
    public Tuple11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> concat(Tuple0 t) {
        return this;
    }
