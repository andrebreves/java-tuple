...
public class Tuple6Test {
    ...
    public void compareTo_shouldReturnCorrectValue_whenComparingTwoCompatibleTuples() {
        Tuple6<Integer, Integer, Integer, Integer, Integer, Integer> t1 = Tuple6.of(0, 0, 0, 0, 0, 0);
        Tuple6<Integer, Integer, Integer, Integer, Integer, Integer> t2 = Tuple6.of(1, 1, 1, 1, 1, 1);
